...
<div  class="">
    <div class="pt-20">
        <img class="w-full" src="/img/contact/insurance-partner-banner.png" alt="">
    </div>
    <div  class="xl:w-[1206px] xl:mx-auto sm:w-full sm:mx-0 xl:px-0 sm:px-2 xl:pt-10 sm:pt-6 xl:mb-24 sm:mb-4 ">
        <div class="flex xl:flex-row sm:flex-col xl:gap-[290px] sm:gap-0">
            <div class="xl:mb-0 sm:mb-4">
                <h1 class="text-title-green font-family xl:text-4xl sm:text-3xl ">daftar bengkel <span class="text-footer-black">rekanan asuransi</span></h1>
        ...
        <div class="mt-6">
           <div class="shadow-xl rounded-xl">
            <div class="flex flex-row w-full bg-side-gray text-footer-black xl:text-lg font-bold font-lato xl:p-4 sm:p-2 rounded-tl-xl rounded-tr-xl">
                <div class="w-[7%]">
            ...
            <div id="partner-table-row">
                ...
                <div class="flex flex-row w-full border-b-2 text-footer-black font-lato xl:p-4 sm:p-2 border-b-gray-300 font-400 xl:text-[16px] sm:text-xs">
                    <div class="w-[7%]">
...
function renderTable(query) {
    ...
    url.searchParams.append('type', 'insurance');
