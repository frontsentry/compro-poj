...
<div class=" text-footer-black">
    <div class="xl:w-[1206px] xl:mx-auto sm:w-full sm:mx-0 xl:px-0 sm:px-2 flex xl:flex-row sm:flex-col">
        <div class="flex flex-col xl:w-3/5 sm:w-full">
            <div class="mt-6">
                <h1 class="text-title-green xl:text-4xl sm:text-3xl uppercase font-family">cara <span class="text-footer-black">melapor </span></h1>
                
            </div>

            <div class="mt-6 text-footer-black font-lato text-xl">
                <h1 class="font-bold">1. Pilih Tab Lapor</h1>
                <p class="text-lg">Bisa melalui TAB Lapor</p>
            </div>

            <div class="mt-6 text-footer-black font-lato text-xl">
                <h1 class="font-bold">2. Pengisian Form</h1>
                <p class="text-lg">Perhatikan baik-baik beberapa hal dibawah ini:<br>
                    - Semua kotak yang diberi tanda (*) wajib diisi.<br>
                    - Pastikan informasi yang diberikan sedapat mungkin memenuhi unsur pengaduan (4W + 1H).</p>
            </div>

            <div class="mt-6 text-footer-black font-lato text-xl">
                <h1 class="font-bold">3. Melampirkan Bukti</h1>
                <p class="text-lg">Jika anda memiliki bukti dalam bentuk file seperti foto atau dokumen lain, silahkan dilengkapi di halaman pengaduan. Adapun caranya:<br>
                    - Setelah membaca petunjuk untuk menyertakan lampiran, klik kotak kecil di bawah petunjuk tersebut, dan lanjutkan prosesnya.</p>
            </div>

            <div class="mt-6 text-footer-black font-lato text-xl">
                <h1 class="font-bold">4. Submit Form</h1>
                <p class="text-lg">Setelah selesai mengisi, silahkan klik tombol "Simpan" untuk melanjutkan atau klik tombol "Reset" untuk membatalkan proses pelaporan anda.</p>
            </div>

            <div class="mt-6 text-footer-black font-lato text-xl">
                <h1 class="font-bold">5. Tambahan Bukti</h1>
                <p class="text-lg">Untuk menambah pengaduan/bukti/data baru, maka Anda dapat mengakses tab "LAPOR" kembali.</p>
            </div>
        </div>
