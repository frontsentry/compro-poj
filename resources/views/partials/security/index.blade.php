<div class="pt-24 text-footer-black">
            ...
            <div class="flex flex-row justify-between mt-4">
                <div class="xl:w-auto sm:w-auto">
                    <div class="flex flex-col text-justify font-400 font-lato xl:text-lg sm:text-sm">
                        Layanan Outsourcing
                        <span class="mt-1 text-justify uppercase xl:text-6xl sm:text-3xl font-family font-400">security</span>
                    </div>
                </div>
                <div class="flex items-center">
                    <img src="/img/security-logo.png" alt="">
                </div>
            </div>

            <iframe class="rounded-lg w-full mt-4 shadow-xl xl:h-[428px] sm:h-auto" width="560" height="315" src="https://www.youtube.com/embed/6c1D-Z25KNs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            
            <div class="mt-6">
                <h1 class="uppercase text-title-green xl:text-4xl sm:text-3xl font-family">jasa Outsourcing <span class="text-footer-black">security</span></h1>
                <p class="text-left font-lato font-400 text-normal xl:mt-2 sm:mt-0">
                    Optima Security System merupakan penyedia layanan jasa petugas keamanan yang terintegrasi dengan Sistem SCC ( <span class="italic">Security Command center</span> ) yang tersebar di seluruh Indonesia. Dikelola secara profesional dan didukung oleh tenaga ahli yang tangguh dan berpengalaman, memberikan pelindungan maksimal di kantor maupun tempat bisnis anda.
                </p>
            </div>
        </div>
    ...
    <div class="xl:w-[1206px] xl:mx-auto sm:w-full sm:mx-0 xl:px-0 sm:px-2 flex xl:flex-row sm:flex-col xl:mt-24 sm:mt-12 font-lato">
        <div class="flex flex-col px-2 xl:w-1/3 sm:w-full">
            <div class="mx-auto">
            ...
            <p class="text-center font-400 text-normal ">
                Merekrut serta melatih Satuan Pengamanan  terbaik dengan sertifikasi Gada Pratama, Gada Madya dan Gada Utama. Dilengkapi sistem Security Command Center, deteksi tindak kejahatan secara real time.
            </p>
        </div>
        <div class="flex flex-col px-2 xl:w-1/3 sm:w-full xl:mt-0 sm:mt-8">
            <div class="mx-auto">
                <img src="/img/sec-2.png" alt="">
            </div>
            <h1 style="font-weight: 800;" class="p-4 mx-auto text-2xl">Berpengalaman</h1>
            <p class="text-center font-400 text-normal ">
                Lebih dari 7 tahun menjaga puluhan mitra perusahaan di seluruh Indonesia.
            </p>
        </div>
        <div class="flex flex-col px-2 xl:w-1/3 sm:w-full xl:mt-0 sm:mt-8">
            <div class="mx-auto">
            ...
            <p class="text-center font-400 text-normal">
                Tenaga Satuan Pengamanan kami juga siap melayani dengan sopan, ramah dan berpenampilan rapi.
            </p>
        </div>
    </div>
