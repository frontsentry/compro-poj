            ...
            <div class="flex flex-row justify-between mt-4">
                <div class="xl:w-auto sm:w-auto">
                    <div class="flex flex-col text-justify font-400 font-lato xl:text-lg sm:text-sm">
                        Layanan Outsourcing
                        <span class="mt-1 text-justify uppercase xl:text-6xl sm:text-3xl font-family font-400">cleaning service</span>
                    </div>
                </div>
                <div class="flex items-center">
                    <img src="/img/cleaning-service/cserv-logo.png" alt="">
                </div>
            </div>
            
            <iframe class="rounded-lg w-full mt-4 shadow-xl xl:h-[428px] sm:h-auto" width="560" height="315" src="https://www.youtube.com/embed/vKF-LNodtp8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            
            <div class="mt-6">
                <h1 class="uppercase text-title-green xl:text-4xl sm:text-3xl font-family">jasa Outsourcing <span class="text-footer-black">Cleaning Service</span> </h1>
                <p class="text-left font-lato font-400 text-normal xl:mt-2 sm:mt-0">
                    Optima Cleaning Service merupakanan penyedia jasa layanan kebersihan terdepan dengan lebih dari 1.500 tenaga Cleaning Service yang tersebar di seluruh Indonesia. Kami berkomitmen untuk menjadi mitra dalam menjaga kebersihan serta kenyamanan lokasi bisnis mitra kami.
                </p>
            </div>
        </div>
    ...
    <div class="xl:w-[1206px] xl:mx-auto sm:w-full sm:mx-0 xl:px-0 sm:px-2 flex xl:flex-row sm:flex-col xl:mt-24 sm:mt-12 font-lato">
        <div class="flex flex-col px-8 xl:w-1/3 sm:w-full">
            ...
            <p class="text-center font-400 text-normal">
                Merekrut serta melatih talenta Cleaning Service terbaik dan berpengalaman di bidang ini.
            </p>
        </div>
        <div class="flex flex-col px-8 xl:w-1/3 sm:w-full xl:mt-0 sm:mt-8">
            ...
            <p class="text-center font-400 text-normal">
                Lebih dari 7 tahun menjaga dan memastikan kebersihan lingkungan area mitra perusahaan di seluruh Indonesia.
            </p>
        </div>
        <div class="flex flex-col px-8 xl:w-1/3 sm:w-full xl:mt-0 sm:mt-8">
            <div class="mx-auto">
            ...
            <p class="text-center font-400 text-normal">
                Cleaning Service kami juga siap melayani dengan sopan, ramah dan berpenampilan rapi.
            </p>
        </div>
    </div>
