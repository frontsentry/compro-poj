            ...
            <div class="flex flex-row justify-between mt-4">
                <div class="xl:w-auto sm:w-auto">
                    <div class="flex flex-col text-justify font-400 font-lato xl:text-lg sm:text-sm">
                        Layanan Rental
                        <span class="mt-1 text-justify uppercase xl:text-6xl sm:text-3xl font-family font-400">alat kantor</span>
                    </div>
                </div>
                <div class="flex items-center">
                    <img src="/img/alat-kantor/alat-kantor-logo.png" alt="">
                </div>
            </div>
            <img class="rounded-xl w-full mt-4 shadow-2xl xl:h-[404px] sm:h-auto" src="/img/alat-kantor/alat-kantor-thumbnail.png" alt="">
            
            <div class="mt-6">
                <h1 class="uppercase text-title-green xl:text-4xl sm:text-3xl font-family">jasa Rental <span class="text-footer-black">alat kantor</span></h1>
                <p class="text-justify font-lato font-400 text-normal xl:mt-2 sm:mt-0">
                    Optima Rent Office Equipment merupakan layanan sewa alat kebutuhan perusahaan yang telah menyediakan lebih dari 7.100 unit untuk kebutuhan operasional seperti printer, laptop, PC atau keperluan branding seperti digital banner.
                </p>
            </div>
        </div>
    ...
    <div class="xl:w-[1206px] xl:mx-auto sm:w-full sm:mx-0 xl:px-0 sm:px-2 flex xl:flex-row sm:flex-col xl:mt-24 sm:mt-12 font-lato">
        <div class="flex flex-col px-8 xl:w-1/3 sm:w-full">
            ...
            <p class="text-center font-400 text-normal">
                Memiliki banyak sumber daya aset office equipment yang siap untuk digunakan kapanpun.
            </p>
        </div>
        <div class="flex flex-col px-8 xl:w-1/3 sm:w-full xl:mt-0 sm:mt-8">
            ...
            <p class="text-center font-400 text-normal">
                Lebih dari 7 tahun melayani berbagai mitra perusahaan untuk kebutuhan operasional ataupun untuk kebutuhan pameran.
            </p>
        </div>
        <div class="flex flex-col px-8 xl:w-1/3 sm:w-full xl:mt-0 sm:mt-8">
            <div class="mx-auto">
            ...
            <p class="text-center font-400 text-normal">
                Memiliki tim IT support yang siap kapanpun untuk melakukan pengecekandan perawatan produk serta menyediakan barang backup.
            </p>
        </div>
