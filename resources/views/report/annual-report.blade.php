...
<div style="background-image: url('/img/report/report-bg.png');" class="bg-center bg-no-repeat bg-contain">
    <div class="pt-20">
        <img class="w-full" src="/img/report/annual-report-banner.png" alt="">
    </div>
        ...
        <div class="grid mx-auto xl:grid-cols-3 sm:grid-cols-2 xl:gap-12 sm:gap-4">
            ...
            <div class="xl:w-[375px]">
                <div class="flex flex-col" >
                    ...
                    <h1 class="font-family font-400 text-footer-black text-center xl:text-[40px] sm:text-xl xl:mt-6 sm:mt-2 xl:mb-0 sm:mb-2">{{ $file->name }}</h1>
                    <h1 class="font-lato font-400 text-title-green text-center xl:text-[20px] sm:text-xl xl:mt-2 sm:mt-2 xl:mb-16 sm:mb-2">{{ $file->description }}</h1>
                </div>
            </div>
            @endforeach
        </div>
